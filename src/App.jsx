    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50 p-4 md:p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-4">
          <img src="/logo2.png" alt="Studio Dancers" style={{ height: '120px' }} className="md:hidden w-auto object-contain mx-auto" />
          <img src="/logo2.png" alt="Studio Dancers" style={{ height: '144px' }} className="hidden md:block w-auto object-contain mx-auto" />
        </div>
